      ...
      <div class="main">
        ...
        <article id="content">
          ...
          <header>
            ...
            <nav>
              <ul id="top_nav">
                <li><a href="CUSTOMERSERVICE.jsp"><img src="images/icon_1.gif" alt=""></a></li>
...
{
   out.println("<tr>");
   out.println("<td><input type='checkbox' name='PID' value='"+rs.getString(1)+"#"+rs.getString(2)+"'</td>");
   out.println("<td>"+rs.getString(1)+"</td>");
   out.println("<td>"+rs.getString(2)+"</td>");
   out.println("<td>"+rs.getString(3)+"</td>");
   out.println("<td>"+rs.getString(4)+"</td>");
   out.println("<td><img src='profilepic/"+rs.getString(5)+"' height=50 width=50 /></td>");
   out.println("</tr>");
 ...
 out.println("<input type=submit value=MAKE_ORDER  />");
 out.println("</form>");
 ...
 {
 %>
 <h2><%=session.getAttribute("usersession") %></h2>
  <a href="UpdateUsers.jsp">UPDATE</a><br>

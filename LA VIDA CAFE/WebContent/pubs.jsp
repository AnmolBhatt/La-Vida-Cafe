...
<html lang="en">
<head>
<title>Deliccio | Cook Book</title>
<meta charset="utf-8">
      ...
      <header>
        ...
        <nav>
          <ul id="menu">
            ...
            <li class="active"><a href="bars.jsp">BARS</a></li>
          ...
          <section class="cols pad_left1">
            <div class="box">
              <div>
                ...
                <p class="pad_bot1"> <strong>1. At vero eos et accusamus</strong><br>
                  ...
                  Similique suculpa qui officia deserunt mollitia animi, id est. </p>
                <a href="#" class="button1">Read More</a> </div>
            </div>
          </section>
        </div>
          ...
          <div class="wrapper line2">
            <div class="col1">
              <div class="wrapper">
                ...
                <p> <a href="#">Sed ut perspiciatis unde omnis iste</a><br>
              ...
              <div class="wrapper">
                ...
                <p> <a href="#">Nemo enim ipsam voluptatem quia voluptas</a> <br>
            ...
            <div class="col2 pad_left1">
              <div class="wrapper pad_bot1">
                ...
                Lorem ipsum dolor sit amet, consecte- tur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. </div>
            </div>
          </div>
        </section>
      </div>
